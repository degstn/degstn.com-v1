...
export default function HardwarePage() {
    return (
      ...
      >
        ...
        <p className="absolute bottom-full left-1/2 transform -translate-x-1/2 whitespace-nowrap hidden group-hover:block hover:underline bg-gray-800 text-gray-50 opacity-50 text-sm rounded">$549</p>
        </div>
        ...
        <p className="absolute bottom-full left-1/2 transform -translate-x-1/2 whitespace-nowrap hidden group-hover:block hover:underline bg-gray-800 text-gray-50 opacity-50 text-sm rounded">$170</p>
        </div>
        ...
        <p className="absolute bottom-full left-1/2 transform -translate-x-1/2 whitespace-nowrap hidden group-hover:block hover:underline bg-gray-800 text-gray-50 opacity-50 text-sm rounded">~$6000</p>
        </div>
        ...
        <p className="absolute bottom-full left-1/2 transform -translate-x-1/2 whitespace-nowrap hidden group-hover:block hover:underline bg-gray-800 text-gray-50 opacity-50 text-sm rounded">not sold to consumers</p>
        </div>
        ...
        <p className="absolute bottom-full left-1/2 transform -translate-x-1/2 whitespace-nowrap hidden group-hover:block hover:underline bg-gray-800 text-gray-50 opacity-50 text-sm rounded">$5499</p>
        </div>
        ...
        <p className="absolute bottom-full left-1/2 transform -translate-x-1/2 whitespace-nowrap hidden group-hover:block hover:underline bg-gray-800 text-gray-50 opacity-50 text-sm rounded">$2200</p>
        </div>
        ...
        <p className="absolute bottom-full left-1/2 transform -translate-x-1/2 whitespace-nowrap hidden group-hover:block hover:underline bg-gray-800 text-gray-50 opacity-50 text-sm rounded">$14000</p>
        </div>
        ...
        <p className="absolute bottom-full left-1/2 transform -translate-x-1/2 whitespace-nowrap hidden group-hover:block hover:underline bg-gray-800 text-gray-50 opacity-50 text-sm rounded">~$5000</p>
        </div>
        ...
        <p className="absolute bottom-full left-1/2 transform -translate-x-1/2 whitespace-nowrap hidden group-hover:block hover:underline bg-gray-800 text-gray-50 opacity-50 text-sm rounded">$2000</p>
        </div>
        </div>
        </div>
        </main>
