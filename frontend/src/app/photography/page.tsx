  ...
  return (
    <main className="min-h-screen flex-grid items-center justify-center bg-bgLight dark:bg-bgDark p-6">
      <div className={berkeleymono.className}>
          <div className="font-mono text-center justify-center text-gray-600 dark:text-gray-50">
            photography <span className="text-international-orange-engineering dark:text-international-orange">[down for maintenance]</span>
          </div>
