  ...
  return (
    <main className="bg-white flex min-h-screen flex-col items-start justify-center">
      ...
      <div className='lg:pt-64 pt-96'>
          ...
          <div className="col-start-1 col-end-3 lg:px-20 pl-10 ">
          <span className="text-4xl bg-clip-text text-transparent bg-gradient-to-r from-rose-400 to-orange-300 tracking-tight font-normal">2024</span>
          </div>
          ...
          <div className="col-start-1 col-end-3 lg:px-20 pl-10 ">
          <span className="text-4xl text-gray-400 tracking-tight font-normal">2023</span>
          </div>
          <div className="col-end-7 col-span-2 lg:px-20 ">
            <span className="text-4xl text-gray-400 tracking-tight font-normal">
          ...
          <div className="col-start-1 col-end-3 lg:px-20 pl-10 ">
          <span className="text-4xl text-gray-400 tracking-tight font-normal">2022</span>
          </div>
          <div className="col-end-7 col-span-2 lg:px-20 ">
            <span className="text-4xl text-gray-400 tracking-tight font-normal">
            <Link href="https://github.com/degstn/">
